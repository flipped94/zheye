<template>
  <div class="post-detail-page">
    <modal title="删除文章" :visible="modalIsVisible"
      @modal-on-close="modalIsVisible = false" @modal-on-confirm="hideAndDelete">
      <p>确定要删除这篇文章吗？</p>
    </modal>
    <article class="w-75 mx-auto mb-5 pb-3" v-if="currentPost">
      ...
      <div
        ...
        <span class="text-muted col text-right font-italic">发表于：{{
          currentPost.createdAt }}</span>
      </div>
      <div v-if="currentPost.isHTML">
        <html-pannel :url="currentHTML"></html-pannel>
      </div>
      <div v-if="!currentPost.isHTML" v-html="currentHTML"></div>
...
import HtmlPannel from '../components/HtmlPannel.vue'
